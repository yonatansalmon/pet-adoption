    ...
    <div className='main-container'>
      <Skeleton isLoaded={!isLoading}>
        <Stack spacing={4} width='60%' justify='center'>
          {pet && (
            <Card direction={{ base: 'column', sm: 'row' }} overflow='hidden' className='font' variant='outline'>
              <Image
                objectFit='cover'
              ...
              <Stack>
                <CardBody>
                  <Stack direction='row'>
                    <Text className='font' fontSize='1.5em' fontWeight='semibold'>
                      Hi I'm {pet?.name}!
                    </Text>
                    <Spacer />
                    <Tag className='font' fontSize='1.2em' mr={3} colorScheme={colorStatus}>
                      {pet?.adoptionStatus}
                    </Tag>
                  </Stack>
