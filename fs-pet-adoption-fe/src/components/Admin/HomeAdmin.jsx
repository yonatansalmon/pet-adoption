...
import { Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon, Spacer } from '@chakra-ui/react';
  ...
  return (
    <>
      <Flex ml='7em' mr='7em' mt={6} justify='left'>
        <Stack>
          <Text bgGradient='linear(to-r, teal.500, purple.500)' bgClip='text' fontSize='4xl' fontWeight='extrabold' mb={2}>
            Admin Dashboard
          </Text>
          <Text className=' font' fontSize='xl' mb={4}>
        ...
        <Button
          ...
          color='cyan.50'
          onClick={(e) => navigate('/admin/addpet')}
          mt={6}
          leftIcon={<AddIcon />}
        >
          Add a new pet
          ...
          <Accordion defaultIndex={[0]} allowMultiple>
              ...
              <h2>
                <AccordionButton>
                  <Box as='span' flex='1' textAlign='left'>
                    <Text color='teal.400' fontSize='2xl' fontWeight='extrabold' mb={6}>
                      View Pets
                    </Text>
                  </Box>
                  <AccordionIcon />
            ...
            <AccordionItem>
              <h2>
                <AccordionButton>
                  <Box as='span' flex='1' textAlign='left'>
                    <Text color='purple.400' fontSize='2xl' fontWeight='extrabold' mb={6}>
                      View Users
                    </Text>
                  </Box>
                  <AccordionIcon />
