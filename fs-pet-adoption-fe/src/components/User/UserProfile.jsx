...
function UserProfile() {
  ...
  const updateUser = async (formData) => {
    ...
    if (userImage) {
      const res = await axios.put(`http://localhost:8080/users/update`, formData, { withCredentials: true });
      ...
      const res = await axios.put(`http://localhost:8080/users/update`, updatedUser, { withCredentials: true });
      console.log(res.data);
      setLoggedInUser(res.data);
    }
  };
      ...
      <Stack spacing={4} width={['100%', '90%', '70%']} align='center'>
        ...
        <Card maxW='md'>
          ...
          <CardBody mt={0}>
            ...
            <Editable className='editable-field' defaultValue={firstName} fontSize='xl' isPreviewFocusable={false}>
              <EditablePreview />
            ...
            <Editable className='editable-field' defaultValue={lastName} fontSize='xl' isPreviewFocusable={false}>
              <EditablePreview />
            ...
            <Editable className='editable-field' defaultValue={email} fontSize='xl' isPreviewFocusable={false}>
              <EditablePreview />
            ...
            <Editable className='editable-field' defaultValue={phone} fontSize='xl' isPreviewFocusable={false}>
              <EditablePreview />
            ...
            <Editable className='editable-field' defaultValue={bio} fontSize='xl' isPreviewFocusable={false}>
              <EditablePreview />
